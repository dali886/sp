...
<head>
	...
	<title>搜索结果 - <?php echo htmlspecialchars($_GET['q']) ?></title>
	<meta name="keywords" content="演示网站关键词<?php echo htmlspecialchars($_GET['q']) ?>搜索页">
	<meta name="description" content="这是一个演示网站的关键词<?php echo htmlspecialchars($_GET['q']) ?>搜索页">
...
<body class="body">
	...
	<div class="header">
		...
		<div class="search">
			<input type="text" placeholder="输入你想看的" id="search" value="<?php echo htmlspecialchars($_GET['q']) ?>" />
			<a id="searchDo"></a>
		</div>
		<div class="navigate">
			<a href="../../">精选</a>
	...
	<div class="keywords" id="keywordItem"><b>“<?php echo htmlspecialchars($_GET['q']) ?>”</b> 的搜索结果：</div>
